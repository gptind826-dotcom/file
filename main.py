...
# Bot Configuration
BOT_TOKEN = "8757066359:AAH2VMHR0tAYD28rMaaEmNVOiL-DJN6HFgQ"
ADMIN_ID = 8379062893
BOT_USERNAME = "filebyexubot"  # Your bot username

# Display name with Unicode bold
BOT_DISPLAY_NAME = "𝐅𝐈𝐋𝐄 𝐁𝐘 𝐄𝐗𝐔 𝐁𝐎𝐓"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        f"⚠️ 𝐍𝐨𝐭𝐞: 𝐈𝐟 𝐲𝐨𝐮 𝐥𝐞𝐚𝐯𝐞 𝐚𝐧𝐲 𝐜𝐡𝐚𝐧𝐧𝐞𝐥, 𝐲𝐨𝐮 𝐰𝐢𝐥𝐥 𝐥𝐨𝐬𝐞 𝐚𝐜𝐜𝐞𝐬𝐬 𝐢𝐦𝐦𝐞𝐝𝐢𝐚𝐭𝐞𝐥𝐲!"
    )
...
async def verify_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if callback_data == "verify_subscription":
        ...
        if link_id not in links_data:
            await query.edit_message_text(f"❌ 𝐈𝐧𝐯𝐚𝐥𝐢𝐝 𝐋𝐢𝐧𝐤!")
            return
        ...
        if not unjoined_entities:
            ...
            if file_id not in files_data:
                await query.edit_message_text(f"❌ 𝐅𝐢𝐥𝐞 𝐍𝐨𝐭 𝐅𝐨𝐮𝐧𝐝!")
                return
...
async def send_file_to_user(update: Update, file_id: str):
    ...
    try:
        ...
        if file_data["file_type"] == "photo":
            await update.message.reply_photo(photo=file_data["file_id"], caption=caption)
        elif file_data["file_type"] == "video":
            await update.message.reply_video(video=file_data["file_id"], caption=caption)
        elif file_data["file_type"] == "document":
            await update.message.reply_document(document=file_data["file_id"], caption=caption)
        elif file_data["file_type"] == "text":
            await update.message.reply_text(f"📝 {file_data.get('name', '𝐓𝐞𝐱𝐭')}\n\n{caption_text}\n\n━━━━━━━━━━━━━━━━━━━━━━\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}")
    except Exception as e:
        logger.error(f"Error sending file: {e}")
        await update.message.reply_text(f"❌ 𝐄𝐫𝐫𝐨𝐫 𝐬𝐞𝐧𝐝𝐢𝐧𝐠 𝐟𝐢𝐥𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐭𝐫𝐲 𝐚𝐠𝐚𝐢𝐧 𝐥𝐚𝐭𝐞𝐫.")
...
async def send_file_to_user_callback(query, file_id: str):
    ...
    try:
        ...
        if file_data["file_type"] == "photo":
            await query.message.reply_photo(photo=file_data["file_id"], caption=caption)
        elif file_data["file_type"] == "video":
            await query.message.reply_video(video=file_data["file_id"], caption=caption)
        elif file_data["file_type"] == "document":
            await query.message.reply_document(document=file_data["file_id"], caption=caption)
        elif file_data["file_type"] == "text":
            await query.message.reply_text(f"📝 {file_data.get('name', '𝐓𝐞𝐱𝐭')}\n\n{caption_text}\n\n━━━━━━━━━━━━━━━━━━━━━━\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}")
    except Exception as e:
        logger.error(f"Error sending file: {e}")
        await query.message.reply_text(f"❌ 𝐄𝐫𝐫𝐨𝐫 𝐬𝐞𝐧𝐝𝐢𝐧𝐠 𝐟𝐢𝐥𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐭𝐫𝐲 𝐚𝐠𝐚𝐢𝐧 𝐥𝐚𝐭𝐞𝐫.")
...
async def admin_generate_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for file_id, file_data in files_list[:10]:
        ...
        keyboard.append([InlineKeyboardButton(f"📁 {file_name[:20]}", callback_data=f"genlink_{file_id}")])
...
async def admin_files_list(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not files_data:
        await update.message.reply_text("📭 𝐍𝐨 𝐟𝐢𝐥𝐞𝐬 𝐡𝐨𝐬𝐭𝐞𝐝 𝐲𝐞𝐭.", reply_markup=get_admin_keyboard())
        return
    ...
    await update.message.reply_text(files_list_text, reply_markup=reply_markup)
...
async def admin_broadcast(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not users_data:
        await update.message.reply_text("📭 𝐍𝐨 𝐮𝐬𝐞𝐫𝐬 𝐟𝐨𝐮𝐧𝐝 𝐭𝐨 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭.", reply_markup=get_admin_keyboard())
        return
...
async def handle_broadcast(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not broadcast_data:
        broadcast_data = {'type': 'text', 'content': None, 'caption': None}
...
async def admin_content_manager(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not files_data and not links_data:
        await update.message.reply_text("📭 𝐍𝐨 𝐜𝐨𝐧𝐭𝐞𝐧𝐭 𝐭𝐨 𝐦𝐚𝐧𝐚𝐠𝐞.\n𝐇𝐨𝐬𝐭 𝐬𝐨𝐦𝐞 𝐟𝐢𝐥𝐞𝐬 𝐟𝐢𝐫𝐬𝐭.", reply_markup=get_admin_keyboard())
        return
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get('awaiting_delete_multiple'):
        try:
            ...
            save_files_data()
            save_links_data()
            await update.message.reply_text(f"✅ 𝐃𝐞𝐥𝐞𝐭𝐞𝐝 {deleted_count} 𝐟𝐢𝐥𝐞(𝐬) 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲!", reply_markup=get_admin_keyboard())
            context.user_data.pop('awaiting_delete_multiple', None)
        except:
            await update.message.reply_text("❌ 𝐈𝐧𝐯𝐚𝐥𝐢𝐝 𝐟𝐨𝐫𝐦𝐚𝐭. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐬𝐞𝐧𝐝 𝐧𝐮𝐦𝐛𝐞𝐫𝐬 𝐥𝐢𝐤𝐞: 1,2,3", reply_markup=get_admin_keyboard())
        return
    ...
    if user_id == ADMIN_ID:
        if message_text == "📝 𝐇𝐨𝐬𝐭 𝐓𝐞𝐱𝐭":
            ...
            await update.message.reply_text("𝐏𝐥𝐞𝐚𝐬𝐞 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐦𝐞𝐧𝐮 𝐛𝐮𝐭𝐭𝐨𝐧𝐬 𝐨𝐫 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬.", reply_markup=get_admin_keyboard())
    else:
        if message_text == "📁 𝐌𝐲 𝐅𝐢𝐥𝐞𝐬":
            ...
            await update.message.reply_text("𝐔𝐬𝐞 /𝐬𝐭𝐚𝐫𝐭 𝐭𝐨 𝐛𝐞𝐠𝐢𝐧 𝐨𝐫 ❓ 𝐇𝐞𝐥𝐩 𝐟𝐨𝐫 𝐚𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐜𝐞.", reply_markup=get_user_keyboard())
...
async def user_my_files(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_files:
        ...
        for i, (file_id, file_data) in enumerate(user_files, 1):
            ...
            files_text += f"{i}. {file_name}\n   𝐀𝐜𝐜𝐞𝐬𝐬𝐞𝐝: {access_date}\n\n"
        files_text += f"━━━━━━━━━━━━━━━━━━━━━━\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}"
        await update.message.reply_text(files_text, reply_markup=get_user_keyboard())
    else:
        await update.message.reply_text(
            f"📭 𝐍𝐨 𝐅𝐢𝐥𝐞𝐬 𝐀𝐜𝐜𝐞𝐬𝐬𝐞𝐝 𝐘𝐞𝐭\n\n"
            f"𝐘𝐨𝐮 𝐡𝐚𝐯𝐞𝐧'𝐭 𝐚𝐜𝐜𝐞𝐬𝐬𝐞𝐝 𝐚𝐧𝐲 𝐟𝐢𝐥𝐞𝐬 𝐲𝐞𝐭.\n"
            f"𝐔𝐬𝐞 /𝐬𝐭𝐚𝐫𝐭 𝐚𝐧𝐝 𝐣𝐨𝐢𝐧 𝐚𝐥𝐥 𝐜𝐡𝐚𝐧𝐧𝐞𝐥𝐬 𝐭𝐨 𝐚𝐜𝐜𝐞𝐬𝐬 𝐟𝐢𝐥𝐞𝐬.\n\n"
            f"━━━━━━━━━━━━━━━━━━━━━━\n"
            f"🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}",
            reply_markup=get_user_keyboard()
        )
...
async def handle_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get('awaiting_file'):
        ...
        if len(parts) < 2:
            await message.reply_text("❌ 𝐅𝐨𝐫𝐦𝐚𝐭: /𝐡𝐨𝐬𝐭 [𝐟𝐢𝐥𝐞𝐧𝐚𝐦𝐞] [𝐜𝐚𝐩𝐭𝐢𝐨𝐧]", reply_markup=get_admin_keyboard())
            return
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if callback_data == "broadcast_confirm":
        ...
        await query.edit_message_text(f"📢 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭𝐢𝐧𝐠...\n\n𝐒𝐞𝐧𝐝𝐢𝐧𝐠 𝐦𝐞𝐬𝐬𝐚𝐠𝐞 𝐭𝐨 𝐚𝐥𝐥 𝐮𝐬𝐞𝐫𝐬.")
        ...
        for user_id_str in users_data.keys():
            try:
                if broadcast_data['type'] == 'text':
                    await context.bot.send_message(chat_id=int(user_id_str), text=broadcast_data['content'] + f"\n\n━━━━━━━━━━━━━━━━━━━━━━\n📢 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 𝐌𝐞𝐬𝐬𝐚𝐠𝐞\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}")
                elif broadcast_data['type'] == 'photo':
                    caption = broadcast_data.get('caption', '')
                    caption += f"\n\n━━━━━━━━━━━━━━━━━━━━━━\n📢 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 𝐌𝐞𝐬𝐬𝐚𝐠𝐞\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}"
                    await context.bot.send_photo(chat_id=int(user_id_str), photo=broadcast_data['content'], caption=caption)
                elif broadcast_data['type'] == 'video':
                    caption = broadcast_data.get('caption', '')
                    caption += f"\n\n━━━━━━━━━━━━━━━━━━━━━━\n📢 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 𝐌𝐞𝐬𝐬𝐚𝐠𝐞\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}"
                    await context.bot.send_video(chat_id=int(user_id_str), video=broadcast_data['content'], caption=caption)
                elif broadcast_data['type'] == 'document':
                    caption = broadcast_data.get('caption', '')
                    caption += f"\n\n━━━━━━━━━━━━━━━━━━━━━━\n📢 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 𝐌𝐞𝐬𝐬𝐚𝐠𝐞\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}"
                    await context.bot.send_document(chat_id=int(user_id_str), document=broadcast_data['content'], caption=caption)
                success_count += 1
        ...
        context.user_data.pop('broadcast_data', None)
        context.user_data.pop('broadcast_mode', None)
        await query.edit_message_text("❌ 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 𝐜𝐚𝐧𝐜𝐞𝐥𝐞𝐝.", reply_markup=get_admin_keyboard())
        ...
        if file_id in files_data:
            ...
            save_files_data()
            save_links_data()
            await query.edit_message_text("✅ 𝐅𝐢𝐥𝐞 𝐝𝐞𝐥𝐞𝐭𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲!")
        ...
        if user_id == ADMIN_ID:
            ...
            save_files_data()
            save_links_data()
            await query.edit_message_text(f"✅ 𝐀𝐥𝐥 𝐟𝐢𝐥𝐞𝐬 𝐚𝐧𝐝 𝐥𝐢𝐧𝐤𝐬 𝐝𝐞𝐥𝐞𝐭𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲!\n\n━━━━━━━━━━━━━━━━━━━━━━\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}")
    
    elif callback_data == "delete_all_links":
        if user_id == ADMIN_ID:
            links_data.clear()
            save_links_data()
            await query.edit_message_text(f"✅ 𝐀𝐥𝐥 𝐥𝐢𝐧𝐤𝐬 𝐝𝐞𝐥𝐞𝐭𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲!\n\n━━━━━━━━━━━━━━━━━━━━━━\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}")
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.edit_message_text(
            f"📋 𝐂𝐨𝐧𝐭𝐞𝐧𝐭 𝐌𝐚𝐧𝐚𝐠𝐞𝐫\n\n📁 𝐓𝐨𝐭𝐚𝐥 𝐅𝐢𝐥𝐞𝐬: {len(files_data)}\n🔗 𝐓𝐨𝐭𝐚𝐥 𝐋𝐢𝐧𝐤𝐬: {len(links_data)}\n\n𝐒𝐞𝐥𝐞𝐜𝐭 𝐚𝐧 𝐨𝐩𝐭𝐢𝐨𝐧:",
            reply_markup=reply_markup
        )
...
async def admin_generate_link_callback(query, context: ContextTypes.DEFAULT_TYPE):
    if not files_data:
        await query.edit_message_text("📭 𝐍𝐨 𝐟𝐢𝐥𝐞𝐬 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞!")
        return
    ...
    if len(files_list) > 10:
        keyboard.append([InlineKeyboardButton("📋 𝐍𝐞𝐱𝐭 𝐏𝐚𝐠𝐞", callback_data="next_page_1")])
    reply_markup = InlineKeyboardMarkup(keyboard)
    await query.edit_message_text(f"🔗 𝐒𝐞𝐥𝐞𝐜𝐭 𝐚 𝐟𝐢𝐥𝐞 𝐭𝐨 𝐠𝐞𝐧𝐞𝐫𝐚𝐭𝐞 𝐥𝐢𝐧𝐤:", reply_markup=reply_markup)

async def admin_files_list_callback(query, context: ContextTypes.DEFAULT_TYPE):
    if not files_data:
        await query.edit_message_text("📭 𝐍𝐨 𝐟𝐢𝐥𝐞𝐬 𝐡𝐨𝐬𝐭𝐞𝐝 𝐲𝐞𝐭!")
        return
    ...
    for i, (file_id, file_data) in enumerate(files_data.items(), 1):
        ...
        file_type = file_data.get('file_type', '𝐔𝐧𝐤𝐧𝐨𝐰𝐧')
        downloads = file_data.get('downloads', 0)
        files_list_text += f"{i}. {file_name}\n   𝐓𝐲𝐩𝐞: {file_type} | 📥 {downloads} 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐬\n\n"
    files_list_text += f"━━━━━━━━━━━━━━━━━━━━━━\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}"
    await query.edit_message_text(files_list_text)

async def admin_links_list_callback(query, context: ContextTypes.DEFAULT_TYPE):
    if not links_data:
        await query.edit_message_text("🔗 𝐍𝐨 𝐥𝐢𝐧𝐤𝐬 𝐠𝐞𝐧𝐞𝐫𝐚𝐭𝐞𝐝 𝐲𝐞𝐭!")
        return
...
async def admin_delete_file_menu(query, context: ContextTypes.DEFAULT_TYPE):
    ...
    for file_id, file_data in list(files_data.items())[:10]:
        file_name = file_data.get('name', f"𝐅𝐢𝐥𝐞_{file_id[:6]}")
        keyboard.append([InlineKeyboardButton(f"🗑️ {file_name[:20]}", callback_data=f"delete_file_{file_id}")])
    reply_markup = InlineKeyboardMarkup(keyboard)
    await query.edit_message_text(f"🗑️ 𝐒𝐞𝐥𝐞𝐜𝐭 𝐚 𝐟𝐢𝐥𝐞 𝐭𝐨 𝐝𝐞𝐥𝐞𝐭𝐞:", reply_markup=reply_markup)
...
async def show_files_page(query, context: ContextTypes.DEFAULT_TYPE, page: int):
    ...
    reply_markup = InlineKeyboardMarkup(keyboard)
    await query.edit_message_text(f"🔗 𝐒𝐞𝐥𝐞𝐜𝐭 𝐚 𝐟𝐢𝐥𝐞 (𝐏𝐚𝐠𝐞 {page+1}):", reply_markup=reply_markup)
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id == ADMIN_ID:
        help_text = (
            ...
            f"📢 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 - 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬\n\n"
            f"𝐅𝐨𝐫𝐜𝐞 𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧:\n"
            f"𝐔𝐬𝐞𝐫𝐬 𝐦𝐮𝐬𝐭 𝐣𝐨𝐢𝐧 𝐚𝐥𝐥 {TOTAL_SUBSCRIPTIONS} 𝐜𝐡𝐚𝐧𝐧𝐞𝐥𝐬:\n"
        )
        for i, entity in enumerate(SUBSCRIPTION_ENTITIES, 1):
            help_text += f"   {i}. {entity['name']}\n"
        help_text += f"\n━━━━━━━━━━━━━━━━━━━━━━\n🤖 𝐁𝐨𝐭 𝐛𝐲: {BOT_DISPLAY_NAME}"
        reply_markup = get_admin_keyboard()
    else:
        help_text = (
            ...
            f"𝟑. 𝐉𝐨𝐢𝐧 𝐚𝐥𝐥 {TOTAL_SUBSCRIPTIONS} 𝐫𝐞𝐪𝐮𝐢𝐫𝐞𝐝 𝐜𝐡𝐚𝐧𝐧𝐞𝐥𝐬\n"
            f"𝟒. 𝐂𝐥𝐢𝐜𝐤 𝐕𝐞𝐫𝐢𝐟𝐲 𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧\n"
            f"𝟓. 𝐆𝐞𝐭 𝐲𝐨𝐮𝐫 𝐟𝐢𝐥𝐞 𝐢𝐧𝐬𝐭𝐚𝐧𝐭𝐥𝐲\n\n"
            f"⚠️ 𝐈𝐌𝐏𝐎𝐑𝐓𝐀𝐍𝐓:\n"
            f"• 𝐈𝐟 𝐲𝐨𝐮 𝐥𝐞𝐚𝐯𝐞 𝐚𝐧𝐲 𝐜𝐡𝐚𝐧𝐧𝐞𝐥, 𝐲𝐨𝐮 𝐥𝐨𝐬𝐞 𝐚𝐜𝐜𝐞𝐬𝐬\n"
            f"• 𝐘𝐨𝐮 𝐦𝐮𝐬𝐭 𝐣𝐨𝐢𝐧 𝐀𝐋𝐋 {TOTAL_SUBSCRIPTIONS} 𝐜𝐡𝐚𝐧𝐧𝐞𝐥𝐬\n\n"
            f"𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬:\n"
            f"/𝐬𝐭𝐚𝐫𝐭 - 𝐒𝐭𝐚𝐫𝐭 𝐛𝐨𝐭\n"
